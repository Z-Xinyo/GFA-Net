...
skeleton_folder = '/dadaY/xinyu/dataset/pkummd/v2/skeleton/'
label_folder = '/dadaY/xinyu/dataset/pkummd/v2/Label/'
save_path = '/dadaY/xinyu/dataset/ST_MGN_data/pkummd/skeleton_pku_v2/'
