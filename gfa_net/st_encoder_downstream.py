...
class SAM(nn.Module):
    ...
    def forward(self, input_tensor):
        ...
        out2 = torch.abs(temp[0].squeeze(1) - temp[1].squeeze(1))
...
class STEncoder_classification(nn.Module):
    """Two branch encoder"""
...
class DownstreamEncoder(nn.Module):
    ...
    def __init__(self, t_input_size, s_input_size, hidden_size, num_head, num_class=60):
        ...
        self.st_encoder = STEncoder_classification(t_input_size, s_input_size, hidden_size, num_head)
